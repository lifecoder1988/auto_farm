<line-height=50%><size=40px>函数</size>
</line-height>
...
<line-height=50%><size=32px>返回值</size>
</line-height>
...
<u><link="docs/scripting/tuples.md">元组</link></u>可以返回多个值。

<line-height=50%><size=32px>默认参数</size>
</line-height>
...
<line-height=50%><size=32px>高级函数用法</size>
</line-height>
