<line-height=50%><size=40px>速度升级</size>
</line-height>
现在，无人机的执行速度翻倍了！但是无人机收获的速度比草生长的速度还快，这会导致根本没有收成。为了解决这个问题，现在解锁了 <u><link="docs/scripting/if.md">if</link></u> 分支和 <u><link="functions/can_harvest">can_harvest</link></u> 函数。

<line-height=50%><size=32px>在收获前检查</size>
</line-height>
